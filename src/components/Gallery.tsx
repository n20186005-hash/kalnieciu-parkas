...
const photos = [
  { src: '/gallery/kalnieciu-parkas (1).jpg', alt: 'Kalniečių parkas entrance' },
  { src: '/gallery/kalnieciu-parkas (2).jpg', alt: 'Park walking paths' },
  { src: '/gallery/kalnieciu-parkas (3).jpg', alt: 'Green lawns and trees' },
  { src: '/gallery/kalnieciu-parkas (4).jpg', alt: 'Park scenery' },
  { src: '/gallery/kalnieciu-parkas (5).jpg', alt: 'Recreational area' },
  { src: '/gallery/kalnieciu-parkas (6).jpg', alt: 'Nature views' },
  { src: '/gallery/kalnieciu-parkas (7).jpg', alt: 'Park landscape' },
  { src: '/gallery/kalnieciu-parkas (8).jpg', alt: 'Peaceful retreat' },
  { src: '/gallery/kalnieciu-parkas (9).jpg', alt: 'Park amenities' },
  { src: '/gallery/kalnieciu-parkas (10).jpg', alt: 'Outdoor activities' },
  { src: '/gallery/kalnieciu-parkas (11).jpg', alt: 'Seasonal beauty' },
  { src: '/gallery/kalnieciu-parkas (12).jpg', alt: 'Natural habitat' },
  { src: '/gallery/kalnieciu-parkas (13).jpg', alt: 'Scenic views' },
  { src: '/gallery/kalnieciu-parkas (14).jpg', alt: 'Park in autumn' },
];

const INITIAL_DISPLAY_COUNT = photos.length;
